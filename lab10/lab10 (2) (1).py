# Generated from: lab10.ipynb
# Converted at: 2026-04-16T17:52:09.201Z
...
upload_file(
    ...
    repo_id="Er-Mukul/dl-lab10-vit-resnet"
)
...
def train_classifier_wandb(model, train_loader, val_loader, optimizer, criterion, config):
    wandb.init(entity="mukulkandpal_25afi11-delhi-technological-university", project="cifar10-vit-resnet", config=config)
