# Generated from: lab8.ipynb
# Converted at: 2026-04-16T17:32:47.987Z
...
def train_autoencoder_wandb(model, train_loader, val_loader, optimizer, config):
    wandb.init(entity="mukulkandpal_25afi11-delhi-technological-university", project="fashion-mnist-ae-vae", config=config)
...
upload_file(
    ...
    repo_id="Er-Mukul/dl-lab8-autoencoder"
)
